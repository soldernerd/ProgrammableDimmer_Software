...
//Set parameters for warm white / cold white implementation
    ...
    #define TIMER_2_STARTING_VALUE 0
    #define TIMER_4_STARTING_VALUE 128
    #define BRIGHTNESS_LEVEL_COUNT 63
    #define BRIGHTNESS_LEVEL_MIN 1
    #define BRIGHTNESS_LEVEL_MAX (BRIGHTNESS_LEVEL_COUNT - 1)
    #define BRIGHTNESS_LEVELS {0, 10, 11, 12, 13, 14, 15, 16, 17, 18, 20, 21, 23, 25, 27, 29, 31, 34, 36, 39, 42, 46, 49, 53, 57, 62, 67, 72, 78, 84, 90, 97, 105, 113, 122, 132, 142, 154, 166, 179, 193, 208, 224, 242, 261, 282, 304, 328, 354, 382, 412, 444, 479, 517, 558, 601, 649, 700, 755, 815, 879, 948, 1023}
    #define COLOR_LEVEL_COUNT 86
    #define COLOR_LEVEL_MIN 0
    #define COLOR_LEVEL_MAX (COLOR_LEVEL_COUNT - 1)
    #define COLOR_LEVELS {0, 3, 6, 9, 12, 15, 18, 21, 24, 27, 30, 33, 36, 39, 42, 45, 48, 51, 54, 57, 60, 63, 66, 69, 72, 75, 78, 81, 84, 87, 90, 93, 96, 99, 102, 105, 108, 111, 114, 117, 120, 123, 126, 129, 132, 135, 138, 141, 144, 147, 150, 153, 156, 159, 162, 165, 168, 171, 174, 177, 180, 183, 186, 189, 192, 195, 198, 201, 204, 207, 210, 213, 216, 219, 222, 225, 228, 231, 234, 237, 240, 243, 246, 249, 252, 256}
    #define COLOR_LEVEL_NEUTRAL 43
